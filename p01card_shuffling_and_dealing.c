/*Покер. 
Функция раздачи должна сдавать по пять карт для игры в покер.
Напишите функции:
1. Определить, имеется ли на руках у игрока пара.
2. Определить, имеется ли на руках у игрока две пары.
3. Определить, имеется ли на руках у игрока тройка(например, три дамы).
4. Определить, имеется ли на руках каре(напримет, четыре туза).
5. Определить, имеется ли на руках у игрока флеш(пять карт одной масти).
6. Определить, имеется ли на руках у игрока стрит(карты последовательных номиналов).
Необходимо написать функцию, которая сдает двум игрокам по пять карт и оценивает,
 чья карта лучше. Программа должна исполнять роль ведущего. Карты сдающего
 кладутся "лицом вниз", так что играющий с программой их не видит. Программадолжна
 затем оценить карту сдающего и, основываясь на качестве карт, сдающий должен взять 
 себе одну, две или три карты взамен не устраивающих его карт из первоначально 
 розданных. После этого прогррамма должна оценить карты сдающего еще раз.
 Программа должна манипулировать картами сдающего, а играющий с программой 
 должен решать сам, какие карты ему нужно менять. Программа должна
 затем оценивать карты играющих и определять победителя.*/
